...
Plots of predicted values of various return levels appear in
Figure~\ref{fig:returnLevels}. The same information appears in Table~\ref{tab:rl}.

<<returnLevels, echo=FALSE, fig.cap="Predicted return levels. The heavy lines represent 50\\% interval estimates and the lighter lines represent 90\\% interval estimates.", results="asis">>=
...
print(xtable(srl, label="tab:rl", digits=1,
             caption="Predicted M-subject return levels."),
